...
// import ExampleCarouselComImage from 'components/ExampleCarouselComImage';
...
const CarouselCom = () => {
  return (
            ...
            <img
                className="d-block w-100"
                src="https://img.freepik.com/premium-photo/girl-write-open-white-book-accounting-minimal-clean-light-blue-desk-with-laptop-accessories-copy-space-flat-lay-top-view-mock-up_315337-7591.jpg"
                alt="Second slide"
            />
            <Carousel.Caption>
